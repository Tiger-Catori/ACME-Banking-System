...
public class HelpSystem {
    ...
    public void showHelp(Menu menu) {
        System.out.println("\n========== HELP ==========");
        System.out.println(menu.getHelpText());
        System.out.println("==========================\n");
    }

    public void showAccountTypeHelp() {
        System.out.println("\n========== ACCOUNT TYPES ==========");
        System.out.println("Personal Account — Sort code: 60-60-60. Min opening balance £1. Overdraft up to £500.");
    ...
    public void showTransactionHelp() {
        System.out.println("\n========== TRANSACTION RULES ==========");
